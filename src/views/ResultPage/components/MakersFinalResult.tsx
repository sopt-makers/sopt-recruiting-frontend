    ...
    <>
      {pass ? (
        <p className={contentVar[deviceType]}>
          ...
          <span className="amp-mask">{`향후 활동은 ${SOPT_NAME} 공식 노션과 카카오톡 단체 대화방, ${SOPT_NAME} 공식 디스코드 등을 통해 운영 및 진행됩니다.\n\n`}</span>
          <span className="amp-mask">{`오늘 중으로 카카오톡 단체 대화방에 초대해드릴 예정이니 참고 부탁드립니다.\n\n`}</span>
...
export default MakersFinalResult;

        ...
        <p className={contentVar[deviceType]}>
          ...
          <>
            ...
            <span className="amp-mask">{`모든 면접 대상자 분들을 대상으로 면접 가능 시간을 조사하려 합니다. 
              아래 구글폼을 내일 22시(9/10 목요일 오후 10시)까지 제출해 주세요. \n\n`}</span>
            ...
            <span>
              ...
              모레(9/11 금요일) 오후 12시 전으로 이메일을 통해 전해드리겠습니다.
      ...
      !pass && !__IS_MAKERS__ ? (
        ...
        <p className={contentVar[deviceType]}>
          ...
          <>
            ...
            <span>
              {`
              제출해주신 폼 내용을 기반으로 확정된 면접 일정 및 면접 안내를 내일(8월 13일) 오후 2시 전으로 이메일을 통해 공유드리겠습니다.

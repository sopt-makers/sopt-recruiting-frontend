...
import { MENU_ITEMS_MAKERS, MENU_ITEMS_SOPT, SIGNED_IN_MENU_ITEMS_MAKERS, SIGNED_IN_MENU_ITEMS_SOPT } from '../../contants';
import MenuItem from '../MenuItem';

const MenuList = () => {
  const isSignedIn = localStorage.getItem('soptApplyAccessToken');

  const menuItems = __IS_MAKERS__
  ? isSignedIn
    ? SIGNED_IN_MENU_ITEMS_MAKERS
    : MENU_ITEMS_MAKERS
  : isSignedIn
    ? SIGNED_IN_MENU_ITEMS_SOPT
    : MENU_ITEMS_SOPT;
